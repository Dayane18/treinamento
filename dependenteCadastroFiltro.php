                                                    ...
                                                    <fieldset>
                                                        <div class="row">
                                                            <section class="col col-4">
                                                                ...
                                                                <label class="input"></i>
                                                                    <input id="dependente" maxlength="50" name="dependente" type="text" value="" pattern="[a-zA-Záãâéêíîóôõú\s]+$" onkeyup="verificarNome()">
                                                                </label>
                                                            </section>
...
<script>
    ...
    function listarFiltro() {
        ...
        var dependenteFiltro = $('#dependente').val();
        var ativoFiltro = $('#ativo').val();

        var parametrosUrl = '&dependenteFiltro=' + encodeURIComponent(dependenteFiltro) + '&ativoFiltro=' + encodeURIComponent(ativoFiltro);
        $('#resultadoBusca').load('dependenteCadastroListagem.php?' + parametrosUrl);
    }
