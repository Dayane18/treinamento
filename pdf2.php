...
$sql = "SELECT * FROM Funcionarios WHERE (0=0) AND codigo =" . $id;
...
class PDF extends FPDF
{
    ...
    function Header()
    {
        ...
        // $this->Image('img/ntlLogo2021.jpg', 5, 5, 10, 10); #logo da empresa
        $this->SetXY(190, 5);
...
$pdf->Cell(200, 5, iconv('UTF-8', 'windows-1252', "RELATÓRIO GERAL"), 0, 0, "C", 0);
$pdf->Ln(10);
$pdf->Line(5, 30, 205, 30); #Linha na Horizontal
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(193, 3, iconv('UTF-8', 'windows-1252', "DADOS DOS FUNCIONÁRIOS: 
"), 0, 0, "L", 0);
$pdf->Ln(4);
...
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "CPF:"), 0, 0, "L", 0);
$pdf->Ln(4);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "GENÊRO:"), 0, 0, "L", 0);
$pdf->Ln(4);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "PRIMEIRO EMPREGO:"), 0, 0, "L", 0);
$pdf->Ln(4);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "RG:"), 0, 0, "L", 0);
$pdf->Ln(4);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "ESTADO CIVIL:"), 0, 0, "L", 0);
$pdf->Ln(4);

$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(20, 5, iconv('UTF-8', 'windows-1252', "PIS/PASEP:"), 0, 0, "L", 0);
$pdf->Ln(4);
...
foreach ($arrayTransporte as $key) {
    ...
    $valorTransporte = number_format($valorTransporte, 2, ',');

    $pdf->SetX(35);
    $pdf->SetWidths(array(30, 35, 40, 30 ));
    $pdf->Row(array($trajetoTransporte, $tipoTransporte, $linhaTransporte,"R$ " . $valorTransporte));
}
$pdf->Ln(8);
...
$pdf->Ln(8);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(100, 5, iconv('UTF-8', 'windows-1252', "Local: _______________________________"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->SetX(16);
$pdf->Cell(100, 5, iconv('UTF-8', 'windows-1252', "$cidade"), 0, 0, "L", 0);
// $pdf->SetFont('Arial', '', 8);
// $pdf->Cell(70, 5, iconv('UTF-8', 'windows-1252', $bairro), 0, 0, "L", 0);
$pdf->SetFont('Arial', 'B', 8);
...
$pdf->Cell(12, 5, iconv('UTF-8', 'windows-1252', " $dataAtual"), 0, 0, "L", 0);
$pdf->SetFont('Arial', '', 8);
$pdf->Ln(8);
$pdf->SetFont('Arial', 'B', 8);
$pdf->Cell(16, 5, iconv('UTF-8', 'windows-1252', "Assinatura:___________________________________________________________________________"), 0, 0, "L", 0);
$pdf->Ln(8);
